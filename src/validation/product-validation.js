...
class ProductValidator {
    ...
    static productValidation() {
        ...
        check('price').isFloat({gt : 0.0}).withMessage('Preço tem que ser maior que 0').isDecimal({decimal_digits:'0,2'}).withMessage("Somente são aceitos números com dois digitos após a vírgula")
        ]
    }
